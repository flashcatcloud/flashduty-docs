...
Knowledge Packs are one type of AI SRE resource and follow the same two-level scope model. The scope rules for other resources (Skills, MCP, Agents, Environments) are identical — see [Extensible Resources](/en/ai-sre/customize).
...
This two-level scope model applies uniformly to all resources within the account (Skills, MCP, Agents, Environments). See [Extensible Resources](/en/ai-sre/customize) for the complete rules.
