...
Knowledge Packs are one type of AI SRE resource and follow the same two-level scope model. The scope rules for other resources (Skills, MCP, A2A agents, Environments) are identical — see [Resource Scope & Permissions](/en/ai-sre/customize).
...
This two-level scope model applies uniformly to all resources within the account (Skills, MCP, A2A agents, Environments). See [Resource Scope & Permissions](/en/ai-sre/customize) for the complete rules.
