...
<Info>
  **Public beta**: AI SRE is now open to all accounts — no application needed. Sign in to the console and start using it. Accounts that have not activated AI SRE run in trial mode (usage is recorded but not billed); once you activate it (or switch a trial account to paid billing), usage is billed in credits — see [Billing & credits](/en/ai-sre/billing). Features and the UI may continue to evolve.
</Info>
