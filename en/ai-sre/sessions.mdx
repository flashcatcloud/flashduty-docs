...
For the rules governing team scope for resources (account scope vs. team scope, visibility, and edit permissions), see <a href="/en/ai-sre/customize">Extensible Resources</a>.
