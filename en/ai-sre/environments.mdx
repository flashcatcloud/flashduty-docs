...
<Accordion title="Security and compliance" icon="users">
  You control the OS account, filesystem permissions, and outbound network policy of the machine running the Runner. Combined with the scope and permission model, you can restrict a Runner to be visible only to specific teams, satisfying least-privilege and audit requirements.
</Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Resource Scope & Permissions" icon="sliders" href="/en/ai-sre/customize">
    Unified explanation of the two-level account / team scope, permission model, and on-demand runtime loading.
  </Card>
