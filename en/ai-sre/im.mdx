...
<Note>
War room auto-diagnosis is bound to the incident context: when the investigation begins, the corresponding `incident_id` is attached to the run so AI SRE can read the incident details, timeline, and recent changes. For details on how incidents / war rooms interact with A2A, see [A2A Agents · Incident & War Room Integration](/en/ai-sre/agents#incident--war-room-integration).
</Note>
...
For session runtime details, see [Chat & Sessions](/en/ai-sre/sessions).
...
<CardGroup cols={2}>
  ...
  <Card title="Operations Insight Report" icon="chart-line" href="/en/ai-sre/insight">
