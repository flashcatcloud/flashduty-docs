...
<Card title="GitHub App" icon="github" href="/en/ai-sre/github">
  After you authorize a GitHub organization, AI SRE works directly inside your repos in a session: understand code, investigate PRs and commits, and open a PR or file an issue on request.
</Card>
</CardGroup>
