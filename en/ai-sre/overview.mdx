...
<Accordion title="Public Beta Billing" icon="gift">
  AI SRE starts charging on **September 16, 2026 (Beijing time)**, metered in credits across **model usage, sandbox online time and web search**; usage before that date is not charged. Allowance and credit-package details will be announced separately.
</Accordion>
