...
## Public Beta and Usage Requirements

---

AI SRE is available to accounts on On-call Pro or higher at no additional charge during the public beta. Review these requirements before you start:

<AccordionGroup>
<Accordion title="Plan requirement: On-call Pro or higher" icon="key">
  AI SRE is available to accounts on **On-call Pro or higher**. If the account does not meet the requirement, upgrade its On-call plan first.
</Accordion>
<Accordion title="No additional charge during public beta" icon="gift">
  AI SRE is available at no additional charge during the public beta. Features and the UI may continue to change.
</Accordion>
<Accordion title="Human approval for production actions" icon="hand">
  AI SRE can investigate, query, and recommend actions, but you retain final approval for production changes, restarts, rollbacks, and external notifications.
</Accordion>
</AccordionGroup>
...
<Steps>
  <Step title="Activate Access">
    Confirm that the account is on On-call Pro or higher. AI SRE is available at no additional charge during the public beta.
  </Step>
...
<CardGroup cols={2}>
<Card title="15-minute quick start" icon="bolt" href="/en/ai-sre/quickstart">
  Start with a real incident and complete your first investigation with context, evidence, and room for follow-up questions.
</Card>
