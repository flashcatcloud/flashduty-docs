...
<Accordion title="Billing" icon="gift">
  Accounts that have not activated AI SRE run in trial mode: usage is recorded but not billed. Once you enable AI SRE (or switch a trial-mode account to paid billing), usage is deducted in the order trial credits → credit packages → pay-as-you-go, and activation itself is free. See [Billing & credits](/en/ai-sre/billing) for entry points, package prices, and low-credit reminders; the full terms are in the [AI SRE credit package purchase agreement](/en/compliance/ai-sre-credit-package-purchase-agreement).
</Accordion>
