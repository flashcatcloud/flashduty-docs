...
Skills share the same **two-level scope** model with other resources (Knowledge Packs, MCP, A2A agents, environments), divided into account level and team level:
