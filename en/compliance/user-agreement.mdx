...
description: "Review the legal terms governing user registration, account management, and use of Flashduty services."
---
...
2.4.3 You have the right to actively cancel your account by sending an email to [support@flashcat.cloud](mailto:support@flashcat.cloud) to request account cancellation.
...
### **3.10 AI-Assisted Features**

3.10.1 Flashcat Cloud provides capabilities assisted by generative AI in certain features of the Services (including but not limited to the incident "AI Summary", hereinafter "AI Features"). AI Features are triggered by you, and the system generates text content based on incident and other business information you are authorized to access, by calling third-party large-model services deployed within the People's Republic of China.

3.10.2 **Content produced by AI Features is automatically generated by AI models, is of a draft and reference nature, may contain errors or omissions, and does not constitute any commitment, factual determination, or professional opinion of Flashcat Cloud. The platform adds a prominent notice to AI-generated content (such as "This content is AI-generated and for reference only; please verify carefully"). You should review and verify such content before use and are solely responsible for decisions made based on it; you must not remove, tamper with, or conceal the AI-generated notice before distributing such content.**

3.10.3 You undertake not to use AI Features to produce, copy, publish, or spread the illegal or harmful information listed in Article 4.4.2 of this Agreement, nor to induce the generation of such information or circumvent the platform's safety review mechanisms by crafting inputs. If you breach the foregoing undertaking, Flashcat Cloud is entitled to take measures under this Agreement, including restricting features and suspending or terminating the Services.

3.10.4 To deliver AI Features, the system processes only the information directly necessary for the generation you trigger, and performs sensitive-information redaction and content-safety review before submission to the third-party large-model service; Flashcat Cloud does not use your data to train or fine-tune AI models. For details on personal information processing, see the [Privacy Policy](/en/compliance/privacy-policy).

3.10.5 If you believe content generated by AI Features is illegal, incorrect, or infringes your lawful rights, you may complain or report via the in-product feedback entry or by emailing [contact-us@flashcat.cloud](mailto:contact-us@flashcat.cloud), and Flashcat Cloud will review and act promptly.
