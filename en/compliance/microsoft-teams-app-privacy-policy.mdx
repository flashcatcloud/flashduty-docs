...
sidebarTitle: "Teams app privacy policy"
...
This policy applies to the Teams app. General personal information handling for Flashduty services is governed by the [Privacy Policy](/en/compliance/privacy-policy), and general data protection terms are described in the [Data Protection Protocol](/en/compliance/data-security) and [User Agreement](/en/compliance/user-agreement).
