...
<!-- REVIEW: Add overview — explain how preset severity rules enable automatic error classification, and how they differ from custom alert grading -->

### Configuration

<!-- REVIEW: Please add the following:
- Rule creation UI steps or API documentation
- Filter syntax (contains, not contains operators)
- Available filter keys (are they the same as custom alert grading match fields?)
