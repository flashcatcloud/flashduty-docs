...
| Page Path (`error.view_url_path`) | Path portion of the page URL | `/checkout/confirm` |
...
| Device Type (`error.device_type`) | User device type | `mobile`, `desktop` |
| OS Name (`error.os_name`) | User operating system name | `Windows`, `iOS` |
