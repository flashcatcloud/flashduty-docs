...
<!-- REVIEW: Add overview — explain how AI/LLM embeddings are used in error grouping, including semantic grouping and intelligent deduplication -->

### Configuration

<!-- REVIEW: Please add the following:
- How semantic grouping works (how LLM embeddings are used for error similarity calculation)
- List of AI-powered features (intelligent grouping, similarity analysis, etc.)
- Detailed deduplication mechanics (how the system determines whether two errors are duplicates)
- Comparison and synergy with traditional fingerprint matching
-->
