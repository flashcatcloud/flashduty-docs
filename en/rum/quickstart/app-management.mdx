...
- **WeChat Mini Program**: Shows npm package installation, npm build steps in WeChat DevTools, initialization of `@flashcatcloud/miniprogram-rum` in `app.js`, and toggles for page, action, request, error, and performance collection
