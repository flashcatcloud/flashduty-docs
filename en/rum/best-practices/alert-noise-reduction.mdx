...
## Error ingestion filtering rules

<!-- REVIEW: Add overview — explain how error ingestion filtering rules filter Errors at ingestion time, and how they differ from data filtering -->

### Configuration

<!-- REVIEW: Please add the following:
- Ingestion filter rule creation UI steps
- Available filter keys
- Filter syntax (contains, not contains, boolean operators)
- Multi-condition combinations (AND/OR) usage
