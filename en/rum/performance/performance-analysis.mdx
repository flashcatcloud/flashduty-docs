...
<Tabs>
  ...
  <Tab title="Metric Perspective">
    ...
    - Switch between different metrics to view their distribution. The dropdown lists only the metrics available for the current app's platform (WeChat Mini Program and browser / Electron have different metric sets); the options change with the app
