...
{/* REVIEW: Feature overview — Detail view mode selector on list pages */}

On list pages such as Performance Analysis, Error Tracking, and Session Replay, you can choose the detail view mode:

| Mode | Description |
|------|-------------|
| **Sidebar Panel** | {/* REVIEW: Opens a detail panel on the right side of the current page for quick browsing */} |
| **Full Page Navigation** | {/* REVIEW: Navigates to a standalone detail page for in-depth analysis */} |

<Tip>
You can switch between the two modes based on your preference. Sidebar mode is suitable for quickly browsing multiple records, while full page mode is better for in-depth analysis of a single record.
</Tip>
{/* END REVIEW */}
