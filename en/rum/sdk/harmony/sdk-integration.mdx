...
<Info>
The current SDK module version is `0.2.0`. The examples use `@flashcatcloud/core`, `@flashcatcloud/rum`, `@flashcatcloud/trace`, and `@flashcatcloud/crash`.
</Info>
...
{
  dependencies: {
    "@flashcatcloud/core": "0.2.0",
    "@flashcatcloud/rum": "0.2.0",
    "@flashcatcloud/trace": "0.2.0",
    "@flashcatcloud/crash": "0.2.0"
  }
}
```
