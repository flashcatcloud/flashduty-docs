...
description: "Quickly integrate Flashcat Android RUM SDK for real-time monitoring of app performance, errors, and user behavior"
---
...
<Step title="Add SDK Dependencies">
  Add Flashcat SDK dependencies in your app module's `build.gradle` file:
...
<Frame>
  <img src="https://docs-cdn.flashcat.cloud/imges/png/68ee9835732aad09e4e134f30bd2cccd.png" alt="RUM Application Management page showing Application ID and Client Token locations" />
</Frame>
</Step>
...
- To track requests when app is in background, see [Track Background Events](#track-background-events)
...
<Step title="Trigger Test Events">
  ...
  - Perform user actions (clicks, swipes, etc.) to verify interaction events
