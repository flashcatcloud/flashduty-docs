---
title: "Compatibility"
description: "Learn about Flashcat iOS RUM SDK supported platform versions, development tools, UI frameworks, and network library compatibility"
---
...
|------|----------------|-------|
| **WKWebView** | ✅ Fully supported | Requires integrating `FlashcatWebView` module |
...
| Module Name | Description | Platform Support | Required |
|-------------|-------------|------------------|----------|
| **FlashcatCore** | Core SDK, provides basic functionality | iOS, iPadOS, tvOS, macOS | ✅ Required |
| **FlashcatRUM** | RUM data collection and reporting | iOS, iPadOS, tvOS | ✅ Required |
| **FlashcatWebView** | WebView integration support | iOS, iPadOS | Optional |
| **FlashcatCrash** | Crash reporting (integrates PLCrashReporter) | iOS, iPadOS, tvOS | Recommended |
