...
description: "Quickly integrate Flashcat iOS RUM SDK for real-time monitoring of app performance, errors, and user behavior"
---

<Info>
Flashcat iOS RUM SDK supports **iOS 12.0, iPadOS 12.0, tvOS 12.0** and above. By integrating the SDK, you can monitor your iOS app's performance, errors, and user behavior in real-time.
</Info>
