...
## Session and replay quota limits

<!-- REVIEW: Add overview — explain the session and replay quota/rate limiting mechanism -->

### Configuration

<!-- REVIEW: Please add the following:
- Specific quota limits
- Quota reset schedule (monthly/daily etc.)
- Per session type (user, synthetic, etc.) quotas
- Behavior when quota limits are reached (stop collection/degrade/notify etc.)
- Session replay independent quota details
-->

### Usage

<!-- REVIEW: Add instructions on how to check current quota usage and recommendations when quota is insufficient -->
<!-- END REVIEW -->
