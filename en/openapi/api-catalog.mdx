...
<Accordion title="RUM (34 endpoints)">
...
| POST | [`/rum/issue/preset-severity/rules/list`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-read-list) | List preset severity rules |
| POST | [`/rum/issue/preset-severity/rules/create`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-write-create) | Create preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/update`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-write-update) | Update preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/enable`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-write-enable) | Enable preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/disable`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-write-disable) | Disable preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/delete`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-write-delete) | Delete preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/reorder`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-write-reorder) | Reorder preset severity rules |
| POST | [`/rum/issue/preset-severity/rules/history/list`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-read-history-list) | List preset severity rule history |
| POST | [`/rum/issue/preset-severity/rules/history/revert`](/en/api-reference/rum/issues/rum-app-issue-preset-severity-rule-write-history-revert) | Restore preset severity rule history |

### Error tracking

| Method | Endpoint | Description |
| :--- | :--- | :--- |
| POST | [`/rum/error-ingestion/rules/list`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-read-list) | List error ingestion rules |
| POST | [`/rum/error-ingestion/rules/create`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-write-create) | Create error ingestion rule |
| POST | [`/rum/error-ingestion/rules/update`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-write-update) | Update error ingestion rule |
| POST | [`/rum/error-ingestion/rules/enable`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-write-enable) | Enable error ingestion rule |
| POST | [`/rum/error-ingestion/rules/disable`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-write-disable) | Disable error ingestion rule |
| POST | [`/rum/error-ingestion/rules/delete`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-write-delete) | Delete error ingestion rule |
| POST | [`/rum/error-ingestion/rules/history/list`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-read-history-list) | List error ingestion rule history |
| POST | [`/rum/error-ingestion/rules/history/revert`](/en/api-reference/rum/error-tracking/rum-app-error-ingestion-rule-write-history-revert) | Restore error ingestion rule history |
