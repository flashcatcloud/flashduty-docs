...
Flashduty Open API provides **305** endpoints covering five major modules: On-call, Monitors, RUM, AI SRE, and Platform. All endpoints use unified authentication and request specifications. See [Quick Start](/en/openapi/introduction) for details.

<Note>
All endpoint URLs use `https://api.flashcat.cloud` as the base, authenticated via APP Key through query string.
</Note>

<Accordion title="On-call (175 endpoints)">
...
<Accordion title="RUM (35 endpoints)">
...
### Preset severity rules

| Method | Endpoint | Description |
| :--- | :--- | :--- |
| POST | [`/rum/issue/preset-severity/rules/list`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-read-list) | List preset severity rules |
| POST | [`/rum/issue/preset-severity/rules/create`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-write-create) | Create preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/update`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-write-update) | Update preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/enable`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-write-enable) | Enable preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/disable`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-write-disable) | Disable preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/delete`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-write-delete) | Delete preset severity rule |
| POST | [`/rum/issue/preset-severity/rules/reorder`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-write-reorder) | Reorder preset severity rules |
| POST | [`/rum/issue/preset-severity/rules/history/list`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-read-history-list) | List preset severity rule history |
| POST | [`/rum/issue/preset-severity/rules/history/revert`](/en/api-reference/rum/issues/rum-issue-preset-severity-rules-write-history-revert) | Revert preset severity rules |

### Error tracking

| Method | Endpoint | Description |
| :--- | :--- | :--- |
| POST | [`/rum/error-ingestion/rules/list`](/en/api-reference/rum/error-tracking/rum-error-ingestion-read-list) | List error ingestion rules |
| POST | [`/rum/error-ingestion/rules/create`](/en/api-reference/rum/error-tracking/rum-error-ingestion-write-create) | Create error ingestion rule |
| POST | [`/rum/error-ingestion/rules/update`](/en/api-reference/rum/error-tracking/rum-error-ingestion-write-update) | Update error ingestion rule |
| POST | [`/rum/error-ingestion/rules/enable`](/en/api-reference/rum/error-tracking/rum-error-ingestion-write-enable) | Enable error ingestion rule |
| POST | [`/rum/error-ingestion/rules/disable`](/en/api-reference/rum/error-tracking/rum-error-ingestion-write-disable) | Disable error ingestion rule |
| POST | [`/rum/error-ingestion/rules/delete`](/en/api-reference/rum/error-tracking/rum-error-ingestion-write-delete) | Delete error ingestion rule |
| POST | [`/rum/error-ingestion/rules/history/list`](/en/api-reference/rum/error-tracking/error-ingestion-rule-read-historylist) | List error ingestion rule history |
| POST | [`/rum/error-ingestion/rules/history/revert`](/en/api-reference/rum/error-tracking/error-ingestion-rule-write-historyrevert) | Revert error ingestion rules to a history snapshot |

### Resource usage

| Method | Endpoint | Description |
| :--- | :--- | :--- |
| POST | [`/rum/resource/info`](/en/api-reference/rum/resource-usage/rum-resource-read-info) | Get RUM resource usage |

### Session replay

| Method | Endpoint | Description |
| :--- | :--- | :--- |
| POST | [`/rum/session-replay/metadata`](/en/api-reference/rum/session-replay/sessionreplay-read-metadata) | Get session replay metadata |
| POST | [`/rum/session-replay/segments`](/en/api-reference/rum/session-replay/sessionreplay-read-segments) | List session replay segments |
