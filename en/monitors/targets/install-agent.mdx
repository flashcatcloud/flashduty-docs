...
| Edge address | For example, `ws://edge.example.com:6868` or `wss://edge.example.com:6868`. View the Edge list and installation method [here](https://console.flashcat.cloud/monit/engine/list). |
