...
| Item | Description |
|---|---|
| Agent package download URL | `https://static.flashcat.cloud/monitagent/monitagent-v0.1.3-linux-amd64.tar.gz`. For ARM CPUs, replace `amd64` with `arm64`. |
...
sudo curl -sfLO "https://static.flashcat.cloud/monitagent/monitagent-v0.1.3-linux-amd64.tar.gz"
sudo tar -xzf monitagent-v0.1.3-linux-amd64.tar.gz --strip-components=1
