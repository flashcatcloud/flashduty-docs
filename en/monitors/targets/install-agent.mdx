...
sudo curl -sfLO "https://static.flashcat.cloud/monitagent/monitagent-v0.0.20-linux-amd64.tar.gz"
sudo tar -xzf monitagent-v0.0.20-linux-amd64.tar.gz --strip-components=1
