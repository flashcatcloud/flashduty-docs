...
Clicking a rule's `Triggered` or `Healthy` status in the alert rules list switches you to the "Active Alerts" tab filtered by that rule (URL parameter `active_alert_rule_id`).
