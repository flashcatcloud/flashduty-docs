...
| `.EnrichLabels` | `map[string]string` | Always empty while rendering `Description`; label enrichment runs after description rendering. Do not rely on it in Description templates. |
