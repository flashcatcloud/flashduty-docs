...
New **External Incident Submission** feature allows external users (such as customers or partners) to submit incidents without signing in:

- Submit incidents via API or a standalone page
- Upload screenshots and attachments with submissions
- Automatically match escalation rule for incident assignment
