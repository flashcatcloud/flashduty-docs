...
<Update label="2026-09-11" description="💳 AI SRE billing, invite links and QR codes, AI query assistant for alert rules">

### AI SRE billing goes live

AI SRE moves from a free public beta to a billed product. The **Payment → Plan → AI SRE** tab covers activation and billing:

- **Enabling is free**: new accounts start on the trial credits, and in trial mode usage is still recorded but not charged; click **Switch to paid billing** whenever you want charging to begin
- **Deduction order**: trial credits → credit package expiring soonest → pay-as-you-go
- **Three credit packages**: 1,000 / 5,000 / 20,000 credits at ¥950 / ¥4,500 / ¥17,000, valid for 365 days from a successful payment and never auto-renewed; buy more at any time
- **Pay-as-you-go**: 1 credit = ¥1, settled from the account's general wallet. The monthly cap has three states — unlimited, a set monthly cap, or pay-as-you-go forbidden (AI SRE stops once the packages are used up). Once the cap is reached, new runs stop and the last run already under way can finish
- **Balance reminder**: for accounts on paid billing, when the credits available this period (trial credits + packages + pay-as-you-go cap combined) fall to 20% of total capacity, the account and its enabled admins receive an SMS and an email — one reminder per period per credit level

See [AI SRE Billing](/en/ai-sre/billing) and the [AI SRE Credit Package Purchase Agreement](/en/compliance/ai-sre-credit-package-purchase-agreement).
