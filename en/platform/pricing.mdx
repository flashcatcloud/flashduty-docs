...
The Payment center is available on SaaS only — On-Premises deployments do not expose this entry. Open **Payment** from the left navigation: the page is titled **Billing** and contains the **Top up** and **Transactions** tabs. The same menu also leads to **Plan** — the page titled **Your Plans**, split into the **On-Call**, **AI SRE** and **RUM** tabs; activating, closing and billing AI SRE are all managed from the **AI SRE** tab (rules: [AI SRE Product Overview](/en/ai-sre/overview#activation-and-billing)).
