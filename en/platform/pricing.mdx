...
Quota reminders apply **only to paid accounts** (Standard / Pro, not a trial, not expired): only SMS, voice calls, and emails **actually sent successfully and counted toward the quota** are counted, and free accounts do not receive this kind of reminder.

For a paid account, when a free quota is running low, the system sends **reminder emails** (email only — never SMS or a phone call):
