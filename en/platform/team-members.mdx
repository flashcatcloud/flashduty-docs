...
<!-- REVIEW: Please add license management feature description -->

| License Type | Description |
|-------------|-------------|
| Fixed License | <!-- REVIEW: Long-term validity, cannot be preempted --> |
| Temporary License | <!-- REVIEW: Automatically released at end of period, must be reclaimed --> |
| No License | <!-- REVIEW: Releases all licenses, can be reclaimed in the next period --> |
<!-- END REVIEW -->
