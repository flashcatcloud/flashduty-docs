...
<Note>
Inviting new members requires an active subscription. Once the subscription expires, the **Invite members** button on the member management page is disabled, and hovering it shows "Your subscription has expired, so you cannot create a new member. Existing members are unaffected." Existing members can keep working as usual.
</Note>
