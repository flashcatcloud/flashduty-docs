...
<!-- REVIEW: Please add description of how domain configuration affects SSO and email integration -->

### Changing Domain

<!-- REVIEW: Please add the modification workflow, including MFA verification requirements -->

### Impact Scope

<!-- REVIEW: Please add the impact of domain changes on the following features -->
<!-- END REVIEW -->
