...
<Steps>
  ...
  <Step title="Configure Permissions">
    On the role detail page under the **Permission List** tab, click **Edit Permissions**, select the permission points to grant to this role, and save.
  </Step>
  <Step title="Assign Members">
    On the role detail page under the **Authorized Members** tab, click **Edit Members** to add or remove members for this role.
  </Step>
</Steps>
