...
go-flashduty is the official Go SDK for Flashduty. Built in the go-github style, it provides a typed wrapper over the Flashduty OpenAPI covering 333 API operations across 37 services, so you can call them directly from Go with full type safety and autocompletion.
