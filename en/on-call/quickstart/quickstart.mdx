---
title: "Flashduty On-call Getting Started"
sidebarTitle: "Getting Started"
description: "Set up Flashduty On-call in 10 minutes, from integrating alerts and configuring escalation rules to receiving phone notifications."
---
...
<Tabs>
  <Tab title="Dedicated Integration (Recommended for Beginners)">
    **Path**: Channel Details Page → **Configuration** → **Integrations** → **Private integration** → **Add an integration**
...
<Warning>
**Prerequisites**:
- To receive **Phone/SMS** notifications, first bind your phone number in **Personal → Profile**
...
<AccordionGroup>
  <Accordion title="Can't receive phone/SMS notifications?">
    Go to **Personal → Profile** to check whether your phone number is verified, and under **Personal → Notification**, confirm that phone/SMS channels are enabled in **Incident dispatch**.
  </Accordion>
