...
<Frame caption="Template Escalation Rule Configuration Example">
  ![Template Escalation Rule Configuration](https://download.flashcat.cloud/flashduty/kb/dynamic-escalate-rule.png)
</Frame>
...
<Frame caption="Dynamic Assignment Result">
  ![Dynamic Assignment Result Display](https://download.flashcat.cloud/flashduty/kb/dynamic-escalate-inc.png)
</Frame>
