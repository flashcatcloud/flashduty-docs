...
| **Invite Followers to War Room** | Only shown if a war room has been created for the incident and its IM integration is still enabled; lets you pull additional members into the corresponding IM war room group. Not shown once the integration is disabled or deleted |
| **Close War Room** | Same condition as above; closes the IM war room group. Not shown once the integration is disabled or deleted — the account owner or an administrator unlinks the war room instead. See [War Room](/en/on-call/advanced/war-room) for details |
