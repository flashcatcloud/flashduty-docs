...
When the page shows extended fields, CSV export can also include alert counts, active alert counts, alert events, owner, closer, snoozed until, ever muted, and outlier incident fields.
