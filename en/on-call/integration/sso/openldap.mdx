...
After completing the configuration, click **Test connection** below the LDAP form in the **Protocol & connection** section to verify that Flashduty can successfully connect to the OpenLDAP server. Once the connection succeeds, click **Save**.
