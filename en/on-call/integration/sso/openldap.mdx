...
After completing the configuration, click the **Connection Test** button below the LDAP parameters in the "Protocol & Connection" section to verify that Flashduty can successfully connect to the OpenLDAP server. Once the connection succeeds, click **Save**.
