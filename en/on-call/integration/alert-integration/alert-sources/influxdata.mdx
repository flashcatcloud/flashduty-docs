---
title: "InfluxData Alert Integration"
description: "Integrate InfluxData alerts with Flashduty On-call through a webhook for automated routing, deduplication, and noise reduction."
keywords: ["alert integration", "InfluxData", "webhook", "alert routing", "noise reduction"]
---
