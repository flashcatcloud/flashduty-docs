---
title: "UCloud CloudWatch Alert Integration"
description: "Sync UCloud CloudWatch alert events to Flashduty via webhook for automated alert noise reduction"
keywords: ["UCloud", "CloudWatch", "alert integration", "webhook", "cloud monitoring"]
---
...
## Severity Mapping
---
Currently, all Ucloud CloudWatch alert events pushed to Flashduty have a severity of Warning. You can customize the severity through [Alert Processing Pipeline](https://docs.flashduty.com/en/on-call/integration/alert-integration/alert-pipelines).
