...
- **Allow group @ AI SRE**: Available without enabling War Room. Lets users start a conversation by @mentioning AI SRE in a group chat connected through this integration. When disabled, this entry point does not respond.
