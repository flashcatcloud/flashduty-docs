...
- **Allow group @ AI SRE and /fd commands**: Available without enabling War Room. Lets users @mention AI SRE or use `/fd` in a Slack group connected through this integration. When disabled, neither entry point responds.
