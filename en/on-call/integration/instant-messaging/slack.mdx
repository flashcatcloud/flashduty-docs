...
- **Allow group @ AI SRE and /fd commands**: Lets users @mention AI SRE or use `/fd` in a Slack group connected through this integration. When disabled, neither entry point responds.
