...
<Note>
Make sure the custom app **Visibility** covers all members who may be invited to War Rooms. WeCom does not provide a Slack-like or Feishu/Lark-like per-scope list. War Room creation, member invitation, and message delivery mainly depend on app visibility, basic API permissions, contact authorization, and callback configuration.
</Note>
