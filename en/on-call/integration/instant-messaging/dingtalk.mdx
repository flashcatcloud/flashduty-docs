...
After you enable **War Room**, the configuration page shows the following AI SRE controls. Both are enabled by default:

- **Automatically start AI incident analysis**: Starts an AI incident analysis when a War Room is created successfully.
- **Allow group @ AI SRE**: Lets users start a conversation by @mentioning AI SRE in a group chat connected through this integration. When disabled, this entry point does not respond.
