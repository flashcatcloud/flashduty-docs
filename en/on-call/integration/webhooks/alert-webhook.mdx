...
| data_source_id | int64 | Yes | Integration ID, same as integration_id |
| data_source_name | string | Yes | Integration name, legacy field kept for compatibility (Deprecated), use integration_name instead |
| data_source_type | string | Yes | Integration type, legacy field kept for compatibility (Deprecated), use integration_type instead |
| data_source_ref_id | string | No | Integration reference ID, legacy field kept for compatibility (Deprecated), use integration_ref_id instead |
