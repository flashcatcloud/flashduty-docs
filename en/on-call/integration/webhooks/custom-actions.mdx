...
6. If the target service uses a self-signed certificate or a certificate issued by an internal CA, you can enable the **Skip TLS Verification** option so the system will not validate the server certificate
7. Save to complete
