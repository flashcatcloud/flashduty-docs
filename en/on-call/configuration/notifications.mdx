...
Flashduty On-call allows you to customize personalized notification messages for different channels.
  ...
  <Accordion title="What notification does an @mention in an incident comment send?" icon="at">
    When you type `@` to mention a member in an incident detail comment or a postmortem report, the system sends the mentioned person a notification containing the comment summary, incident information, and a detail link that jumps straight to the incident.
