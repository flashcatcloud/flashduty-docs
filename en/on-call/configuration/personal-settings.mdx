...
| --- | --- |
| **Voice** | Notify via phone call (may not be available in private deployment) |
| **SMS** | Notify via text message |
| **Email** | Send notifications via email |
| **Flashduty APP** | Push notifications through the Flashduty mobile app |
| **IM Apps** | Send notifications through integrated Dingtalk, Feishu/Lark, WeCom, Slack, or Microsoft Teams apps. You can select specific IM integration instances |
...
To use Dingtalk, WeCom, Feishu/Lark, or other IM notifications, first complete account linking in the corresponding app. You can select multiple notification channels for each level to ensure important alerts are not missed.
