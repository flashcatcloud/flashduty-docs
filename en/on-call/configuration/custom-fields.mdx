...
<Note>
The number of custom fields is governed by account quota: up to **15** by default; some accounts have a higher quota (up to **50**) or no limit. Refer to the quota displayed on the page. Once the limit is reached, the create button is disabled and shows a "Creation limit reached" message.
</Note>
...
<Card title="Custom Forms" icon="file-lines" href="/en/on-call/configuration/custom-forms">
Collect additional information when creating, acknowledging, and closing incidents
</Card>
</CardGroup>
