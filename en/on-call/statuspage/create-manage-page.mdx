...
description: "Learn how to configure branding, custom domains, display settings, subscription switches, and editing or deletion for a status page"
---
...
<Note>
Public status pages do not support IM subscriptions, and internal status pages do not support email subscriptions. For subscriber import/export, RSS/Atom, and one-click unsubscribe, see [Subscription management](/en/on-call/statuspage/subscriptions).
</Note>
