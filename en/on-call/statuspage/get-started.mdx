...
This guide is for teams adopting Flashduty Status Page for the first time. It covers only two entry paths: **create a status page from scratch** or **migrate from Atlassian Statuspage to Flashduty Status Page**.
...
| Goal | Doc |
| --- | --- |
| Configure branding, domain, display settings, and subscription switches | [Configure status page basics](/en/on-call/statuspage/create-manage-page) |
