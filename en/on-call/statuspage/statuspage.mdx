...
<!-- REVIEW: Auto-generated stub from coverage-audit. These features exist in code but lack documentation. -->

## Subscriber management

<!-- REVIEW: Add subscriber management overview -->

### Bulk import

<!-- REVIEW: Add steps and format requirements for bulk importing subscribers -->

### Bulk export

<!-- REVIEW: Add steps for bulk exporting subscribers -->

## Display configuration

<!-- REVIEW: Add description of status page display configuration options -->

| Setting | Description |
|---------|-------------|
| Component visibility | <!-- REVIEW: hideAll parameter --> |
| Uptime display mode | <!-- REVIEW: displayUptimeMode parameter --> |
| Uptime display | <!-- REVIEW: hideUptime parameter --> |
| Date format | <!-- REVIEW: dateView parameter --> |

## Incident linking

<!-- REVIEW: Add instructions for linking status page events to on-call incidents -->

## Custom branding

<!-- REVIEW: Add description of custom branding configuration -->

| Setting | Description |
|---------|-------------|
| Custom domain | <!-- REVIEW: Add details --> |
| Logo | <!-- REVIEW: Add details --> |
| Header/footer | <!-- REVIEW: Add details --> |
| Contact info | <!-- REVIEW: Add details --> |

## Subscription rate limiting

<!-- REVIEW: Add description of subscription endpoint rate limiting -->

<Note>
<!-- REVIEW: Single IP limited to 100 requests per 24 hours, global limit of 1,000,000 requests per 24 hours -->
</Note>
<!-- END REVIEW -->