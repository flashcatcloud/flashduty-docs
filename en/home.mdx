...
<Note>
AI SRE is now in **public beta** and open to all accounts — no application needed. Accounts that have not activated it run in trial mode (usage is recorded but not billed); once activated, or after buying a credit package, usage is billed in credits — see [Billing & credits](./ai-sre/billing). See the [AI SRE introduction](./ai-sre).
</Note>
