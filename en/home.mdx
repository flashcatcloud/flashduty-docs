...
<CardGroup cols={2}>
  ...
  <Card title="AI SRE" icon="robot" href="./ai-sre">
    Autonomous troubleshooting Agent (Beta)
  </Card>
</CardGroup>
...
<Note>
AI SRE is currently in **private beta** and **free during the beta** (it will be paid after launch; pricing announced separately). It requires a Pro or higher subscription and whitelist access. See the [AI SRE introduction](./ai-sre).
</Note>
