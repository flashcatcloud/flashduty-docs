...
<Note>
AI SRE is now in **public beta** and open to all accounts — no application needed. From September 16, 2026 (Beijing time) it starts charging, metered in credits across model usage, sandbox online time and web search; usage before that date is not charged. See the [AI SRE introduction](./ai-sre) and [Credits and Billing](./ai-sre/credits).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Product Comparison" icon="scale-balanced" href="./on-call/comparison/vs-pagerduty">
