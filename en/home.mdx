...
<Note>
AI SRE is now in **public beta** and open to all accounts — no application needed. Billing starts on September 16, 2026 (Beijing time), metered in credits; usage before that date is free. See the [AI SRE introduction](./ai-sre).
</Note>
