...
<Note>
AI SRE is now in **public beta** and open to all accounts, no application needed. Starting September 16, 2026, it's billed on usage. See the [AI SRE introduction](./ai-sre) and [billing terms](./compliance/ai-sre-credit-package-purchase-agreement).
</Note>
