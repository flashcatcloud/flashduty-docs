...
<Note>
AI SRE is available to accounts on **On-call Pro or higher** at no additional charge during the public beta. Features and the UI may continue to change. You retain final approval for production changes, restarts, rollbacks, and external notifications. See the [AI SRE introduction](./ai-sre).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="15-minute quick start" icon="comments" href="./ai-sre/quickstart">
    Start your first read-only investigation from a real incident
  </Card>
</CardGroup>
