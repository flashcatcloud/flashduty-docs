---
title: "RUM 真实用户监控"
description: "RUM 真实用户监控能够帮您从终端用户视角出发，直观地分析和了解 Web 应用的实时性能和用户体验。"
keywords: ["RUM", "真实用户监控", "性能监控", "异常追踪", "会话重放"]
sidebarTitle: "RUM"
---
...
<CardGroup cols={2}>
  ...
  <Card title="SDK 集成指南" icon="code" href="/zh/rum/app-management/sdk-integration">
