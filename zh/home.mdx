...
<Note>
AI SRE 面向 **On-call 专业版及以上**账户开放，公测期间不单独收费；功能与界面可能继续调整。生产变更、重启、回滚和外部通知仍由你最终确认。详见 [AI SRE 产品介绍](./ai-sre)。
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="15 分钟快速开始" icon="comments" href="./ai-sre/quickstart">
    从一个真实故障开始第一次只读调查
  </Card>
</CardGroup>
