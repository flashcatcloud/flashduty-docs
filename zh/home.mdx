...
<Note>
AI SRE 目前处于**内测**阶段，专业版及以上用户可申请**免费试用**；正式商用后收费，Flashduty 会提供计费信息，你可以选择正式开通或暂停使用。通过 [AI SRE 内测申请表](https://c9xudyniiq.feishu.cn/share/base/form/shrcn0ngCfdoygiaHnAT80BfZiH) 申请，详见 [AI SRE 产品介绍](./ai-sre)。
</Note>
