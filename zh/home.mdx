...
<Note>
AI SRE 目前处于**公测**阶段，面向 On-call 专业版及以上账户灰度开放，公测期间不单独收费；如需开通，请填写 [AI SRE 公测申请表](https://c9xudyniiq.feishu.cn/share/base/form/shrcn0ngCfdoygiaHnAT80BfZiH)。正式商用前 Flashduty 会提前提供计费信息。详见 [AI SRE 产品介绍](./ai-sre)。
</Note>
