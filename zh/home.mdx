...
<Note>
AI SRE 已全量开放**公测**，无需申请，登录控制台即可使用。自 2026 年 9 月 16 日（北京时间）起正式收费，按 credits 计量模型用量、沙箱在线时长和联网检索，此前的使用不收取费用；详见 [AI SRE 产品介绍](./ai-sre) 与 [credits 与计费](./ai-sre/credits)。
</Note>
