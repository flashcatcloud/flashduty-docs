...
<CardGroup cols={2}>
<Card title="RUM 高级配置" icon="sliders" href="/zh/rum/app-management/advanced-config">
  了解 RUM SDK 的完整配置选项
</Card>

<Card title="RUM 查看器" icon="magnifying-glass" href="/zh/rum/explorer/overview">
  掌握 RUM 查看器的使用方法
</Card>
</CardGroup>
