---
title: "Web SDK 接入指南"
description: "快速了解如何在 Web 应用中集成 Flashduty RUM SDK，包括 NPM、CDN 异步和 CDN 同步三种接入方式"
keywords: ["RUM", "Web SDK", "用户监控", "前端监控"]
---

<Info>
Flashduty RUM SDK 支持多种接入方式，您可以根据项目需求选择最适合的方案。
</Info>
...
初始用户跟踪同意状态，详见[用户跟踪同意](/zh/rum/app-management/advanced-config#用户跟踪同意)
</ParamField>

<ParamField body="trackViewsManually" type="boolean" default="false">
是否手动控制视图创建，详见[覆盖默认视图名称](/zh/rum/app-management/advanced-config#覆盖默认-rum-视图名称)
</ParamField>
...
用于注入跟踪 Headers 的请求 URL 列表，详见[集成分布式追踪](/zh/rum/app-management/advanced-config#集成-rum-与分布式追踪)
</ParamField>
