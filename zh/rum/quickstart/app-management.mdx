...
<CardGroup cols={3}>
<Card title="SDK 接入指南" icon="code" href="/zh/rum/app-management/sdk-integration">
  了解如何接入 RUM SDK
</Card>

<Card title="高级配置" icon="sliders" href="/zh/rum/app-management/advanced-config">
  了解 SDK 的高级配置选项
</Card>

<Card title="分析看板" icon="chart-line" href="/zh/rum/app-management/analytics-dashboard">
  查看和分析 RUM 数据
</Card>
</CardGroup>
