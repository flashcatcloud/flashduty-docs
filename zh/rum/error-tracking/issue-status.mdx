---
title: "Issue 状态"
description: "了解 Flashduty RUM Issue 状态流转情况"
...
<Info>
所有新发现的 Issue 初始状态为**待处理（for_review）**。Flashduty 会根据特定条件自动更新状态，您也可以手动调整。
</Info>
...
<Steps>
  <Step title="变更状态">
    自动将 Issue 状态变更为**待处理（for_review）**
  </Step>
  <Step title="添加标签">
...
<CardGroup cols={2}>
  <Card title="持续监控" icon="eye">
    定期检查**待处理（for_review）**状态的 Issue，确保新问题和回归问题得到及时处理
  </Card>
