---
title: "Android"
description: "掌握 Flashduty RUM Android SDK 的异常捕获机制，包括 Java/Kotlin 崩溃、NDK 崩溃、ANR 报告、手动上报和符号化配置"
keywords: ["RUM", "异常追踪", "用户监控", "前端监控"]
---

本文档介绍 Flashcat Android RUM SDK 的异常捕获机制，帮助您监控和诊断 Android 应用中的崩溃和错误问题。
