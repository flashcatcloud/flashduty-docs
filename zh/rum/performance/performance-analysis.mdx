...
{/* REVIEW: 功能概述 — 列表页的详情查看模式选择器 */}

在性能分析、异常追踪和会话回放等列表页面中，您可以选择详情的查看模式：

| 模式 | 说明 |
|------|------|
| **侧边栏面板** | {/* REVIEW: 在当前页面右侧打开详情面板，方便快速浏览 */} |
| **全页导航** | {/* REVIEW: 跳转到独立的详情页面，适合深入分析 */} |

<Tip>
您可以根据使用习惯在两种模式间切换。侧边栏模式适合快速浏览多条记录，全页模式适合深入分析单条记录。
</Tip>
{/* END REVIEW */}
