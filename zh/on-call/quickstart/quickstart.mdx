---
title: "Flashduty On-call 入门指南"
sidebarTitle: "入门指南"
description: "10分钟完成从告警接入到接收电话通知的完整流程"
keywords: ["入门指南", "快速开始", "告警接入", "On-call", "电话通知"]
---
...
<Tabs>
  <Tab title="专属集成（推荐新手）">
    **路径**：协作空间详情页 → **配置** → **集成数据** → **专属集成** → **新增一个集成**
...
<AccordionGroup>
  <Accordion title="收不到电话/短信通知？">
    请前往 **我的 → 个人信息** 检查手机号是否已验证，并在 **我的 → 通知偏好** 的 **故障分派** 中确认已开启电话/短信渠道。
  </Accordion>
