...
<Tabs>
  ...
  <Tab title="JSON">
    ...
    | 字段 | 是否必填 | 用途 |
    | --- | --- | --- |
    | <code>id</code> | 否 | AOM 事件 ID；有值时保存为 <code>event_id</code> 标签 |
    | <code>starts_at</code> | 是 | 告警发生时间，Unix 毫秒时间戳 |
    | <code>ends_at</code> | 否 | 大于 0 时表示恢复；缺失、空值或 0 时继续参考 SMN 主题 |
    | <code>metadata.event_name</code> | 是 | 告警名称 |
    | <code>metadata.event_severity</code> | 是 | 告警等级 |
    | <code>metadata.event_type</code> | 是 | 事件类型，通常为 <code>alarm</code> |
    | <code>metadata.resource_provider</code> | 是 | 事件源，例如 <code>AOM</code> 或 <code>CCE</code> |
    | <code>metadata.resource_type</code> | 是 | 资源类型 |
    | <code>metadata.resource_id</code> | 是 | 资源标识 |
...
| 接入格式 | 恢复判断 |
| --- | --- |
| SMN HTML | 优先读取 <code>上报类型</code> 或 <code>Clear Type</code>；无法识别时再读取 SMN <code>subject</code> |
| SMN JSON | <code>ends_at &gt; 0</code> 表示恢复；缺失、空值或 0 时再读取 SMN <code>subject</code> |
| Webhook 数据订阅 | <code>ends_at &gt; 0</code> 表示恢复 |

HTML 模板可识别的恢复值包括 <code>恢复</code>、<code>resolved</code>、<code>recovered</code>、<code>clear</code> 和 <code>cleared</code>；触发值包括 <code>触发</code>、<code>triggered</code> 和 <code>firing</code>。
...
| AOM 字段 | Flashduty 标签 |
| --- | --- |
| <code>id</code> | <code>event_id</code> |
| <code>metadata.event_name</code> | <code>event_name</code>、<code>check</code> |
| <code>metadata.event_severity</code> | <code>event_severity</code> |
| <code>metadata.resource_provider</code> | <code>resource_provider</code> |
| <code>metadata.resource_type</code> | <code>resource_type</code> |
| <code>metadata.resource_id</code> | <code>resource_id</code>，并拆分其中的资源键值对 |
| <code>policy.alarm_rule_name</code> | <code>alarm_rule_name</code> |
| <code>annotations.tms_tags</code> | <code>tms_tags</code> |
| <code>annotations.generator_url</code> | <code>generator_url</code> |
| 英文 HTML 的 <code>Notification Rule</code> | <code>notification_rule</code> |
