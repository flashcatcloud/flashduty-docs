...
|  data_source_id  |         int64         |  是  | 集成 ID，同 integration_id|
| data_source_name |        string         |  是  | 集成名称，兼容保留字段（Deprecated），请使用 integration_name|
| data_source_type |        string         |  是  | 集成类型，兼容保留字段（Deprecated），请使用 integration_type|
