---
title: "数据源管理"
description: "配置和管理 Monitors 的数据源，包括 Prometheus、Elasticsearch、Loki、ClickHouse、MySQL、Oracle、PostgreSQL、SLS、VictoriaLogs 等类型"
keywords: ["数据源", "Prometheus", "Elasticsearch", "Loki", "ClickHouse", "MySQL", "Oracle", "PostgreSQL", "SLS", "VictoriaLogs"]
---
