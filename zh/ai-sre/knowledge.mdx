...
Knowledge Pack 是 AI SRE 资源的一种，遵循统一的两级作用域模型。其他资源（Skill、MCP、Agent、运行环境）的作用域规则与本页一致，详见 [扩展资源](/zh/ai-sre/customize)。
...
这套两级作用域模型对账户内所有资源（Skill、MCP、Agent、运行环境）一致适用，完整规则见 [扩展资源](/zh/ai-sre/customize)。
